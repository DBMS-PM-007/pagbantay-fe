        ...
        <div className="min-h-screen w-full bg-white text-black flex flex-col">
          <div className="w-full max-w-5xl mx-auto px-4 sm:px-10 pb-16">
            {loading ? (
              ...
              <form onSubmit={handleSave} className="w-[350px] mx-auto mt-4 mb-16">
                <div className="flex flex-col h-auto text-md text-black overflow-hidden font-semibold bg-white border border-black rounded-lg text-left shadow-md">
                  <div className="w-full flex items-center gap-2 h-auto px-4 py-3 text-white font-bold bg-[maroon] border-b border-black rounded-t-lg">
                    ...
                    <span className="text-md">Edit An Event</span>
                  </div>

                  <div className="flex flex-col p-4 space-y-4">
                    <div className="space-y-1">
                      <label htmlFor="event_name" className="block text-lg font-bold">
                        Event Name
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="flex justify-between pt-2">
                      <button
                        type="button"
                        onClick={() => navigate("/admin/events")}
                        className="px-4 py-2 border border-[maroon] text-[maroon] rounded-full hover:bg-[maroon]/10 transition"
                      >
                        Cancel
                      </button>
                      <button
                        type="submit"
                        disabled={saving}
                        className="flex items-center gap-2 bg-[maroon] text-white px-4 py-2 rounded-full hover:bg-[maroon]/90 transition disabled:opacity-70"
                      >
                        {saving ? (
                          <>
