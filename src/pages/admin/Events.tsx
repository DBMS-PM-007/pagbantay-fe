        ...
        <div className="min-h-screen w-full bg-white text-black flex flex-col">
          ...
          <div className="w-full max-w-5xl mx-auto px-4 sm:px-10 pb-32">
            ...
            <div className="relative w-full max-w-md mb-10 mx-auto">
              ...
              <button className="absolute right-3 top-1/2 transform -translate-y-1/2 text-black-500">
            ...
            {loading ? (
                ...
                <div className="flex flex-col justify-center pl-[50px] pr-[50px] pt-[20px] pb-[10px] text-sm gap-[20px]">
                  ...
                  <div className="flex justify-end space-x-4 pt-4">
                    <button 
                      ...
                      className="flex items-center mb-2 space-x-1 text-[maroon] hover:underline"
                    >
              ...
              <div className="w-full max-w-2xl space-y-6 mx-auto">
                {filteredEvents.map((event) => (
                  <div key={event.event_id} className="w-[350px] flex flex-col h-auto text-md text-black overflow-hidden font-semibold bg-white border border-black rounded-lg text-left mx-auto shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 hover:scale-[1.01]">
          ...
          <nav className="fixed bottom-0 left-0 w-full bg-white border-t border-black-500 text-black py-1 z-50">
            ...
            {/* Floating Add Event Button with text below the icon */}
